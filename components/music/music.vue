<template>
	<view>
		<!-- 音乐组件 -->
		<!-- 音乐播放列表 -->
		<scroll-view v-if="musicList[0]" :class="[{'musicList-night':isNight},'musicList']" scroll-y="true" :style="'height:calc(100% - 100rpx)'">
			...
			<text v-show="musicList.length>=10" id="musicListButtom">已经到底了~</text>
		</scroll-view>
		...
		<!-- 音乐播放器 -->
		<view class="player" :class="[isNight?'player-night':'player']" :style="'bottom:'+tabHeight+'px'">
			<!-- 封面 -->
